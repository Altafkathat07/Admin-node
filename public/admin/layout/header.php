...
$id = $_SESSION['id']; 
if(empty($id)){
    echo "<script>alert('First Login please...');location.href='page-login.php'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">

<!-- Mirrored from yashadmin.w3itexpert.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 12:41:11 GMT -->
<head>
    <meta charset="utf-8">
